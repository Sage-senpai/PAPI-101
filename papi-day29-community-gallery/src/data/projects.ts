...
export const sampleProjects: Project[] = [
  {
    ...
    description: 'Real-time multi-chain DeFi dashboard with portfolio tracking and yield optimization',
    developer: 'Alex Chen',
    ...
    imageUrl: '/projects/defi-dashboard.png',
  ...
  },
  {
    ...
    description: 'NFT marketplace supporting Polkadot, Kusama, and multiple parachains with instant swaps',
    ...
    imageUrl: '/projects/nft-marketplace.png',
  ...
  },
  {
    id: '3',
    name: 'Governance Pro',
    description: 'Advanced governance platform with proposal simulation and voting analytics',
    ...
    imageUrl: '/projects/governance-platform.png',
  ...
  },
  {
    ...
    description: 'Interactive tutorials and coding challenges for learning PAPI',
  ...
  },
  {
    ...
    description: 'Advanced analytics dashboard with custom metrics and real-time alerts',
  ...
  },
  {
    ...
    description: 'Enterprise-grade multi-signature wallet management with PAPI integration',
